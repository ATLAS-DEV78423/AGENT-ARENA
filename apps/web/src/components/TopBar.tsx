    ...
    <header className="h-14 border-b border-border-subtle flex items-center justify-between px-4 bg-background/80 backdrop-blur-sm sticky top-0 z-40">
      ...
      <div className="flex items-center gap-3">
        ...
        >
          ...
          <span>Search</span>
          <kbd className="ml-2 px-1.5 py-0.5 rounded bg-background text-[10px] font-mono border border-border-subtle">⌘K</kbd>
        </button>
        <div className="w-7 h-7 rounded-full bg-jade-dark flex items-center justify-center text-xs text-jade-light font-medium">S</div>
      </div>
    </header>
  );
}
